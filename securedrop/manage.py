...
from db import db_session, Journalist, PasswordError
...
def add_admin():
    ...
    while True:
        ...
        print('Both the admin and the Journalist should store this as an entry '
              'in their KeePass.')
        answer = raw_input("I understand that password are now autogenerated. (y/N): ")
